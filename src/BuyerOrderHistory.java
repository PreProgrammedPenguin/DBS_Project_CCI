...
public class BuyerOrderHistory extends JFrame {
...
//	}
	...
	public BuyerOrderHistory(int bid, Product prod) {
		this();
		this.prod = prod;
		buyerID = bid;
		try {
	...
	public BuyerOrderHistory() {
		...
		JRadioButton rentButton = new JRadioButton("Rentals");
		rentButton.setActionCommand("R");
		buttonGroup.add(rentButton);
		panel_1.add(rentButton);
		
		JRadioButton buyButton = new JRadioButton("Orders");
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(!rentButton.isSelected() && !buyButton.isSelected())
					...
					try {
						ResultSet tempRS = prod.getOrderHistory(buyerID, type);
						if(tempRS!=null)
		...
		scrollPane.setBounds(10, 55, 677, 366);
