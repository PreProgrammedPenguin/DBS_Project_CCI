...
public class RegisterAdmin extends JDialog {
...
//			RegisterAdmin dialog = new RegisterAdmin(tempUser);
...
//	}
	...
	public void addAdmin() {
		...
		try {
			usr.insertAdmin(fn, ln, email, pwd, pnum);
		} catch(Exception e) {
