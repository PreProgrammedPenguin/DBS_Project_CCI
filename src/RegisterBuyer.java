...
public class RegisterBuyer extends JDialog {
...
//			RegisterBuyer dialog = new RegisterBuyer(tempUser);
...
//	}
	...
	public void addBuyer() {
		...
		try {
			usr.insertBuyer(fn, ln, email, pwd, pnum);
		} catch(Exception e) {
